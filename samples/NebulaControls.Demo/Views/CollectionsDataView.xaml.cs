...
public sealed class DemoDataGridRepository
{
    ...
    private static DemoDataGridRow[] GetValidatedControlCatalog()
    {
        ...
        [
            ...
            new(1006, "NebulaComboBox", "V2", "Validated", "Selection", "Dominique", "Medium", "2026-07-09", "Standard, editable, keyboard and disabled states"),
            new(1007, "NebulaTreeView", "V2", "Validated", "Collections", "Dominique", "Medium", "2026-07-09", "Hierarchy with keyboard navigation and committed selection"),
            ...
            new(1011, "NebulaMessageBox", "V1", "Validated", "Feedback", "Dominique", "Medium", "2026-07-09", "MessageBox-style facade over NebulaDialog"),
            new(1012, "NebulaMenu", "V2", "Validated", "Navigation", "Dominique", "Medium", "2026-06-26", "Menu and context menu hover states"),
            ...
            new(1020, "NebulaToggleButton", "Final", "Validated", "Selection", "Dominique", "Medium", "2026-07-05", "Switch-style binary setting"),
            new(1021, "NebulaSlider", "V2", "Validated", "Inputs", "Dominique", "Medium", "2026-06-26", "Range input with Nebula track and thumb"),
            new(1022, "NebulaProgressBar", "V2", "Validated", "Feedback", "Dominique", "Medium", "2026-06-26", "Determinate progress indicator"),
            new(1023, "NebulaSpinner", "V2", "Validated", "Feedback", "Dominique", "Low", "2026-06-26", "Indeterminate loading indicator"),
            new(1024, "NebulaSearchBox", "V2", "Validated", "Inputs", "Dominique", "High", "2026-06-27", "Search input with clear action and realistic filter demo"),
            new(1025, "NebulaNumericUpDown", "V2", "Validated", "Inputs", "Dominique", "High", "2026-07-02", "Numeric input with buttons, manual entry and range limits"),
            new(1026, "NebulaDatePicker", "V2", "Validated", "Pickers", "Dominique", "High", "2026-07-01", "Custom date picker with calendar popup"),
            new(1027, "NebulaTimePicker", "V2", "Validated", "Pickers", "Dominique", "High", "2026-07-01", "Custom time picker with manual entry and popup selection"),
